 ...
 ************************************/
  ...
  Statement s;
    ...
    jj_consume_token(RBRACE);
    {if (true) return new MainClass(i1,i2, vl, s);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Exp ConditionalAndExpression() throws ParseException {
  Exp e1, e2;
  ...
  Exp e1, e2;
    ...
    while (true) {
      ...
      jj_consume_token(49);
      e2 = PrimaryExpressionWithSuffix();
                                           e1 = new Times(e1, e2);
    }
    {if (true) return e1;}
    throw new Error("Missing return statement in function");
  ...
  static final public Exp PrimaryExpressionWithSuffix() throws ParseException {
  Exp e;
    e = PrimaryExpression();
    label_15:
    while (true) {
  ...
  static final public Exp ArrayLookup(Exp e) throws ParseException {
  Exp e2;
    jj_consume_token(LSQPAREN);
    e2 = Expression();
    jj_consume_token(RSQPAREN);
    {if (true) return new ArrayLookup(e,e2);}
    throw new Error("Missing return statement in function");
  }

  static final public Exp ArrayLength(Exp e) throws ParseException {
  ...
  static final public Exp MessageSend(Exp e) throws ParseException {
  Identifier i;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1000000,0x1000000,0x80800000,0x0,0x80800000,0x0,0x80800000,0x60002000,0x0,0x80800000,0x2000,0x60000000,0x60002000,0x0,0x40000,0x180000,0x180000,0x0,0x10800,0x10400200,0x0,0x10000000,0x400200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x1000,0x8,0x1000,0x8,0x1000,0x1200,0x8000,0x1000,0x0,0x200,0x1200,0x10000,0x0,0x0,0x0,0x20000,0x0,0x1984,0x8000,0x1980,0x4,};
   }
